...
CREATE POLICY "Public Access Payments Sales" ON venda_pagamentos FOR ALL USING (true) WITH CHECK (true);
...
export const patchCrediarioScript = `-- =================================================================
-- PATCH PARA CREDIÁRIO / PAGAMENTOS PARCIAIS
-- =================================================================
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'venda_pagamentos' AND policyname = 'Public Access Payments Sales'
    ) THEN
        CREATE POLICY "Public Access Payments Sales" ON public.venda_pagamentos FOR ALL USING (true) WITH CHECK (true);
    END IF;
END $$;
